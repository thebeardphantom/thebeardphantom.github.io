...
var ASM_CONSTS = {
  3856712: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3856767: ($0) => { performance.now = function() { return $0; }; },  
 3856815: ($0) => { performance.now = function() { return $0; }; },  
 3856863: () => { performance.now = Module['emscripten_get_now_backup']; }
};
